...
// Synchron: berechnet die Mandelbrot-Menge für ein bestimmtes Rechteck
function computeMandelbrotRectSync(rect, imageWidth, imageHeight, computationSettings) {
...
self.onmessage = (event) => {
  ...
  const result = computeMandelbrotRectSync(
    rect,
    imageWidth,
    imageHeight,
    computationSettings
